...
MySQL - 8.0.36 : Database - classicmodels
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`classicmodels` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `customers` (
  ...
  `contactLastName` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `contactFirstName` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `phone` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `addressLine1` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `addressLine2` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `employees` (
  ...
  `officeCode` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `reportsTo` int DEFAULT NULL,
  `jobTitle` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `ksm_kurs_pajak` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'http://www.fiskal.kemenkeu.go.id/2010/edef-kurs-pajak-db.asp',
...
CREATE TABLE `kurs_pajak` (
  `id_ksm_kurs_pajak` int DEFAULT NULL,
  `kurs_rate` decimal(10,4) DEFAULT NULL,
  `tgl` date DEFAULT NULL,
  `curr_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `kurs_pajak` */

insert  into `kurs_pajak`(`id_ksm_kurs_pajak`,`kurs_rate`,`tgl`,`curr_id`) values 
(1,12102.0000,'2014-01-22',8),
(2,12168.0000,'2014-01-29',8),
(3,12203.0000,'2014-02-05',8),
(4,12184.0000,'2014-02-12',8),
(5,11950.0000,'2014-02-19',8),
(6,11793.0000,'2014-02-26',8),
(7,11793.0000,'2014-03-05',8),
(8,11510.0000,'2014-03-12',8),
(9,11393.0000,'2014-03-19',8),
(10,11381.0000,'2014-03-26',8),
(11,11400.0000,'2014-04-02',8),
(12,11313.0000,'2014-04-09',8),
(13,11378.0000,'2014-04-16',8),
(14,11430.0000,'2014-04-23',8),
(15,11544.0000,'2014-04-30',8),
(16,11544.0000,'2014-05-07',8),
(17,11544.0000,'2014-05-14',8),
(18,11466.0000,'2014-05-21',8),
(19,11513.0000,'2014-05-28',8),
(20,11683.0000,'2014-06-04',8),
(21,11841.0000,'2014-06-11',8),
(22,11806.0000,'2014-06-18',8),
(23,11955.0000,'2014-06-25',8),
(24,12020.0000,'2014-07-02',8),
(25,11869.0000,'2014-07-09',8),
(26,11601.0000,'2014-07-16',8),
(27,11666.0000,'2014-07-23',8),
(28,11711.0000,'2014-08-06',8),
(29,11742.0000,'2014-08-13',8),
(30,11684.0000,'2014-08-20',8),
(31,11694.0000,'2014-08-27',8),
(32,11696.0000,'2014-09-03',8),
(33,11750.0000,'2014-09-10',8),
(34,11824.0000,'2014-09-17',8),
(35,11973.0000,'2014-09-24',8),
(36,12020.0000,'2014-10-01',8),
(37,12172.0000,'2014-10-08',8),
(38,12210.0000,'2014-10-15',8),
(39,12168.0000,'2014-10-22',8),
(40,12038.0000,'2014-10-29',8),
(41,12109.0000,'2014-11-05',8),
(42,12109.0000,'2014-11-12',8),
(43,12206.0000,'2014-11-19',8),
(44,12158.0000,'2014-11-26',8),
(45,12158.0000,'2014-12-03',8),
(46,12158.0000,'2014-12-10',8),
(47,12158.0000,'2014-12-17',8),
(48,12158.0000,'2014-12-24',8),
(50,12158.0000,'2014-12-31',8),
(51,12158.0000,'2015-01-07',8),
(52,12653.0000,'2015-01-14',8),
(53,12593.0000,'2015-01-21',8),
(54,13021.0000,'2015-01-28',8),
(55,12946.0000,'2015-04-15',8),
(56,12893.0000,'2015-04-22',8),
(57,12930.0000,'2015-04-29',8),
(58,12973.0000,'2015-05-06',8),
(59,12973.0000,'2015-05-13',8),
(60,12973.0000,'2015-05-20',8),
(61,13147.0000,'2015-05-26',8),
(62,13217.0000,'2015-06-03',8),
(66,13275.0000,'2015-06-10',8),
(67,13324.0000,'2015-06-17',8),
(68,13327.0000,'2015-06-24',8),
(69,13308.0000,'2015-07-01',8),
(70,13335.0000,'2015-07-08',8),
(71,13328.0000,'2015-07-15',8),
(72,13413.0000,'2015-07-29',8),
(74,13483.0000,'2015-08-06',8),
(75,13518.0000,'2015-08-12',8),
(76,13795.0000,'2015-08-19',8),
(77,13904.0000,'2015-08-26',8),
(78,14036.0000,'2015-09-02',8),
(79,14165.0000,'2015-09-09',8),
(80,14303.0000,'2015-09-16',8),
(81,14425.0000,'2015-09-23',8),
(82,14650.0000,'2015-09-30',8),
(83,14664.0000,'2015-10-07',8),
(84,13764.0000,'2015-10-14',8),
(85,13549.0000,'2015-10-21',8),
(86,13665.0000,'2015-10-28',8),
(87,13617.0000,'2015-11-04',8),
(88,13576.0000,'2015-11-11',8),
(89,13648.0000,'2015-11-18',8),
(90,13735.0000,'2015-11-25',8),
(91,13757.0000,'2015-12-02',8),
(92,13816.0000,'2015-12-09',8),
(93,13984.0000,'2015-12-16',8),
(94,13961.0000,'2015-12-23',8),
(95,13640.0000,'2015-12-30',8),
(96,13800.0000,'2016-01-06',8),
(97,13926.0000,'2016-01-13',8),
(98,13899.0000,'2016-01-20',8),
(99,13883.0000,'2016-01-27',8),
(100,13820.0000,'2016-02-03',8),
(101,13658.0000,'2016-02-10',8),
(102,13480.0000,'2016-02-17',8),
(103,13475.0000,'2016-02-24',8),
(104,13407.0000,'2016-03-02',8),
(105,13204.0000,'2016-03-09',8);
...
CREATE TABLE `offices` (
  ...
  `territory` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `payments` (
  `customerNumber` int NOT NULL,
  `checkNumber` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `productlines` (
  ...
  `textDescription` varchar(4000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `htmlDescription` mediumtext COLLATE utf8mb4_general_ci,
  `image` mediumblob,
...
/* Function  structure for function  `find_min_date` */

/*!50003 DROP FUNCTION IF EXISTS `find_min_date` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `find_min_date`(dates VARCHAR(255)) RETURNS date
    READS SQL DATA
BEGIN
    ...
    -- Initialize min_date with a very high value
    ...
    WHILE dates_empty = 0 DO
        ...
        -- If there is no comma, take the rest of the string as the last date
        IF comma_position = 0 THEN
            SET curr_date_str = dates;
            SET dates_empty = 1; -- Set flag to end loop
        ELSE
            -- Extract the date before the first comma
            SET curr_date_str = SUBSTRING(dates, 1, comma_position - 1);
            -- Remove the extracted date from the string
        ...
        -- Compare and update min_date if the curr_date is smaller
...
/* Procedure structure for procedure `extract_kurs_pajak` */

/*!50003 DROP PROCEDURE IF EXISTS  `extract_kurs_pajak` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `extract_kurs_pajak`()
BEGIN
